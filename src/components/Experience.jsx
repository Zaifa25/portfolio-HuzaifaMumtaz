...
const EXPERIENCES = [
  ...
  },
  {
    ...
    status: 'current',
    location: 'Remote',
    stack: ['Flutter', 'Dart', 'Firebase', 'REST APIs', 'Git', 'Agile / Scrum'],
    description:
      'Working remotely at AnchorLogics.net as the App Development Team Lead. Leading the mobile app development team, managing project workflows, reviewing code, and building high-performance cross-platform mobile applications using Flutter and Dart.',
    highlights: [
      'Leading the App Development team — planning sprints, assigning tasks & reviewing pull requests',
      'Building cross-platform mobile applications using Flutter & Dart',
      'Architecting app structure and integrating RESTful APIs & backend services',
      'Enforcing clean code standards and optimizing app performance & responsiveness',
